...
const initialQuestions: Question[] = [
  {
    id: 1,
    text: "Based on your experience, what do you think are the strengths of the program? (Please check all that apply)",
  },
  {
    id: 2,
    text: "Based on your experience, what do you think are the weaknesses of the program? (Please check all that apply)",
  },
  {
    id: 3,
    text: "What can you suggest to improve your overall BSAM student experience?",
  },
  {
    id: 4,
    text: "Will you recommend the BSAM program?",
  },
  {
    id: 5,
    text: "Why or why not?",
  ...
  return (
    <div style={styles.card}>
      ...
      <div style={styles.cardHeader}>
        <h2 style={styles.cardTitle}>Other questions for the improvement of the program</h2>
