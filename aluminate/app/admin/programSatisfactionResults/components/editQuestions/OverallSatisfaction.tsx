...
const initialQuestions: Question[] = [
  {
    id: 1,
    text: "How satisfied are you with each of the following items with regards to your experience at the Department of Math, Physics and Computer Science?",
  },
  ...
  return (
    <div style={styles.card}>
      ...
      <div style={styles.cardHeader}>
        <h2 style={styles.cardTitle}>Overall Satisfaction</h2>
