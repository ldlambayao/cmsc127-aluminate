...
const initialQuestions: Question[] = [
  ...
  { id: 2, text: "Immersion to the values of a liberal arts background", indented: true },
  { id: 3, text: "Faculty members are exemplars of 'honor and excellence'", indented: true },
