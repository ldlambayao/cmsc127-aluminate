...
const initialQuestions: Question[] = [
  ...
  { id: 2, text: "Inclusivity (individuals with diverse backgrounds)", indented: true },
  { id: 3, text: "Faculty members serve as examples of honor and excellence", indented: true },
