...
const initialQuestions: Question[] = [
  {
    id: 1,
    text: "Please rate how the culture in your school environment captures the factors stated below.",
  },
  { id: 2, text: "Inclusivity to the values of a liberal arts background", indented: true },
  { id: 3, text: "Faculty members serve as exemplars of 'honor and excellence'", indented: true },
  { id: 4, text: "Students are encouraged to participate", indented: true },
  { id: 5, text: "The expertise of the faculty", indented: true },
  { id: 6, text: "Please explain your answer above." },
];

export default function IntellectualCulturalEnvironment() {
