...
const initialQuestions: Question[] = [
  { id: 1, text: "What is the level of difficulty of your adjustment to the BSAM program?" },
  { id: 2, text: "Please explain the reason to your answer on the previous question." },
  { id: 3, text: "What will make the transition easier for you?" },
  {
    id: 4,
    text: "What can you suggest to prepare you for the course requirements of the whole BSAM program?",
  },
];

export default function TransitiontoProgram() {
  ...
  return (
    <div style={styles.card}>
      ...
      <div style={styles.cardHeader}>
        <h2 style={styles.cardTitle}>Transition to the Program</h2>
