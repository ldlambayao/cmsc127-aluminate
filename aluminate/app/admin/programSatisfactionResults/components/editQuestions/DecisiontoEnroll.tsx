...
const initialQuestions: Question[] = [
  ...
  { id: 4, text: "Reputation of UP Mindanao", indented: true },
  {
    id: 5,
    text: "Reputation of UP Mindanao Department of Math, Physics and Computer Science",
    indented: true,
  },
  { id: 6, text: "Reputation of the BSAM program", indented: true },
  { id: 7, text: "Reputation/Expertise of the Faculty members", indented: true },
  { id: 8, text: "The program matches my interests", indented: true },
  { id: 9, text: "Financial consideration", indented: true },
  { id: 10, text: "Recommendation of a friend", indented: true },
  { id: 11, text: "Encouragement of parent/s or relatives", indented: true },
  { id: 12, text: "Encouragement of a faculty member", indented: true },
];

export default function DecisiontoEnroll() {
  ...
  return (
    <div style={styles.card}>
      ...
      <div style={styles.cardHeader}>
        <h2 style={styles.cardTitle}>Decision to Enroll</h2>
